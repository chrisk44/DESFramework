...
__host__ __device__ static __inline__ float I5(float xi, float eta, float q, float dip, float nu, float R, float db);
__host__ __device__ static __inline__ float I4(float db, float eta, float q, float dip, float nu, float R);
__host__ __device__ static __inline__ float I3(float eta, float q, float dip, float nu, float R);
__host__ __device__ static __inline__ float I2(float eta, float q, float dip, float nu, float R);
__host__ __device__ static __inline__ float I1(float xi, float eta, float q, float dip, float nu, float R);

__host__ __device__ static __inline__ float ux_ss(float xi, float eta, float q, float dip, float nu);
__host__ __device__ static __inline__ float uy_ss(float xi, float eta, float q, float dip, float nu);
__host__ __device__ static __inline__ float uz_ss(float xi, float eta, float q, float dip, float nu);

__host__ __device__ static __inline__ float ux_ds(float xi, float eta, float q, float dip, float nu);
__host__ __device__ static __inline__ float uy_ds(float xi, float eta, float q, float dip, float nu);
__host__ __device__ static __inline__ float uz_ds(float xi, float eta, float q, float dip, float nu);

__host__ __device__ static __inline__ float ux_tf(float xi, float eta, float q, float dip, float nu);
